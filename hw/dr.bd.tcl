...
proc create_hier_cell_slot0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
    catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_slot0() - Empty argument(s)!"}
    return
  }
  ...
  set_property -dict [ list \
    ...
    CONFIG.CATEGORY {aie} \
    ] [get_bd_intf_pins /slot0/ConfigNoc/M00_AXI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    CONFIG.CONNECTIONS {M00_AXI { read_bw {5} write_bw {5} read_avg_burst {4} write_avg_burst {4}} } \
    ] [get_bd_intf_pins /slot0/ConfigNoc/S00_INI]

  set_property -dict [ list \
    CONFIG.ASSOCIATED_BUSIF {M00_AXI} \
    ] [get_bd_pins /slot0/ConfigNoc/aclk0]
  ...
  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/DDRNoc/M00_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/DDRNoc/M01_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/DDRNoc/M02_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/DDRNoc/M03_INI]

  set_property -dict [list CONFIG.CONNECTIONS {M00_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/DDRNoc/S00_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M01_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/DDRNoc/S01_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M02_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/DDRNoc/S02_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M03_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/DDRNoc/S03_AXI]
  ...
  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/LPDDRNoc/M00_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/LPDDRNoc/M01_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/LPDDRNoc/M02_INI]

  set_property -dict [ list \
    CONFIG.INI_STRATEGY {load} \
    ] [get_bd_intf_pins /slot0/LPDDRNoc/M03_INI]

  set_property -dict [list CONFIG.CONNECTIONS {M00_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/LPDDRNoc/S00_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M01_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/LPDDRNoc/S01_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M02_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/LPDDRNoc/S02_AXI]
  set_property -dict [list CONFIG.CONNECTIONS {M03_INI { read_bw {128} write_bw {128}} }] [get_bd_intf_pins /slot0/LPDDRNoc/S03_AXI]
  set_property -dict [list CONFIG.ASSOCIATED_BUSIF {S03_AXI:S02_AXI:S00_AXI:S01_AXI}] [get_bd_pins /slot0/LPDDRNoc/aclk0]
  ...
  set_property -dict [ list \
    CONFIG.CATEGORY {NOC} \
    ] [get_bd_intf_pins /slot0/ai_engine_0/S00_AXI]
...
#########################################################################################################
  ...
  connect_bd_net -net clk_wizard_0_clk_out2 [get_bd_pins clk_wizard_0/clk_out2] [get_bd_pins psr_156mhz/slowest_sync_clk] [get_bd_pins POWER_0/system_clk]
  ...
  connect_bd_net [get_bd_pins psr_104mhz/peripheral_reset] [get_bd_pins POWER_0/rst_out0]
...
proc create_root_design { parentCell } {
  ...
  # Create instance: slot0
  create_hier_cell_slot0 [current_bd_instance .] slot0
...
set_property -dict [list \
  ...
  CONFIG.PS_PMC_CONFIG { \
    ...
    PMC_MIO_TREE_PERIPHERALS {QSPI#QSPI#QSPI#QSPI#QSPI#QSPI#Loopback Clk#QSPI#QSPI#QSPI#QSPI#QSPI#QSPI#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#USB 2.0#SD1/eMMC1#SD1/eMMC1#SD1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#SD1/eMMC1#GPIO 1#PCIE#PCIE#CANFD1#CANFD1#UART 0#UART 0#LPD_I2C1#LPD_I2C1#LPD_I2C0#LPD_I2C0####SD1/eMMC1#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem0#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem1#Gem0#Gem0} \
    ...
    PS_CRF_FPD_TOP_SWITCH_CTRL_ACT_FREQMHZ {799.999268} \
  ...
  connect_bd_intf_net -intf_net slot0_LPDDR_0 [get_bd_intf_pins slot0/LPDDR_0] [get_bd_intf_pins noc_lpddr/S04_INI]
  connect_bd_intf_net -intf_net slot0_LPDDR_1 [get_bd_intf_pins slot0/LPDDR_1] [get_bd_intf_pins noc_lpddr/S05_INI]
  connect_bd_intf_net -intf_net slot0_LPDDR_2 [get_bd_intf_pins slot0/LPDDR_2] [get_bd_intf_pins noc_lpddr/S06_INI]
  connect_bd_intf_net -intf_net slot0_M03_INI1 [get_bd_intf_pins slot0/LPDDR_3] [get_bd_intf_pins noc_lpddr/S07_INI]
  connect_bd_intf_net -intf_net slot0_M03_INI2 [get_bd_intf_pins slot0/DDR_3] [get_bd_intf_pins noc_ddr/S07_INI]
  ...
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces CIPS_0/PMC_NOC_AXI_0]  [get_bd_addr_segs slot0/ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces CIPS_0/FPD_CCI_NOC_3] [get_bd_addr_segs slot0/ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces CIPS_0/FPD_CCI_NOC_1] [get_bd_addr_segs slot0/ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces CIPS_0/FPD_CCI_NOC_2] [get_bd_addr_segs slot0/ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  assign_bd_address -offset 0x020000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces CIPS_0/FPD_CCI_NOC_0] [get_bd_addr_segs slot0/ai_engine_0/S00_AXI/AIE_ARRAY_0] -force
  ...
  assign_bd_address -offset 0xA7000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CIPS_0/M_AXI_FPD] [get_bd_addr_segs slot0/to_delete_kernel_ctrl_0/S_AXI/Reg] -force
  assign_bd_address -offset 0xA8000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CIPS_0/M_AXI_FPD] [get_bd_addr_segs slot0/to_delete_kernel_ctrl_1/S_AXI/Reg] -force
  assign_bd_address -offset 0xA9000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CIPS_0/M_AXI_FPD] [get_bd_addr_segs slot0/to_delete_kernel_ctrl_2/S_AXI/Reg] -force
  assign_bd_address -offset 0xAA000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces CIPS_0/M_AXI_FPD] [get_bd_addr_segs slot0/to_delete_kernel_ctrl_3/S_AXI/Reg] -force
...
proc create_dfx {} {
  ...
  create_bd_design -cell [get_bd_cells /slot0] slot0
  current_bd_design $curdesign
  set new_cell [create_bd_cell -type container -reference slot0 slot0_temp]
  replace_bd_cell [get_bd_cells /slot0] $new_cell
  delete_bd_objs  [get_bd_cells /slot0]
  set_property name slot0 $new_cell
  ...
  current_bd_design [get_bd_designs slot0]
  ...
  set_property -dict [list CONFIG.LOCK_PROPAGATE {true} CONFIG.ENABLE_DFX {true}] [get_bd_cells slot0]
}
