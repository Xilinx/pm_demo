...
set CLK_WIZ_EVE_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wizard CLK_WIZ_EVE_0 ] 


set_property -dict [ list \
        CONFIG.CLKOUT_REQUESTED_OUT_FREQUENCY {100,200,300,400,100.0,100.0,100.0} \
...
set BUFG_CTRL_0 [ create_bd_cell -type ip -vlnv user.org:user:bufg_ctrl BUFG_CTRL_0 ] 



set BUFG_CTRL_3 [ create_bd_cell -type ip -vlnv user.org:user:bufg_ctrl BUFG_CTRL_3 ] 



set BUFG_CTRL_2 [ create_bd_cell -type ip -vlnv user.org:user:bufg_ctrl BUFG_CTRL_2 ] 
...
set BUFG_CTRL_1 [ create_bd_cell -type ip -vlnv user.org:user:bufg_ctrl BUFG_CTRL_1 ] 


connect_bd_net -net CLK_WIZ_EVE_1_locked_POWER_0_rst_out1 [get_bd_pins CLK_WIZ_EVE_1/locked] [get_bd_pins POWER_0/rst_out1]
connect_bd_net -net CLK_WIZ_EVE_1_clk_out1_BUFG_CTRL_3_I1 [get_bd_pins CLK_WIZ_EVE_1/clk_out1] [get_bd_pins BUFG_CTRL_3/I1]
connect_bd_net -net AXIS_VIO_0_probe_out1_BUFG_CTRL_1_S [get_bd_pins AXIS_VIO_0/probe_out1] [get_bd_pins BUFG_CTRL_1/S]
connect_bd_net -net AXIS_VIO_0_probe_out3_BUFG_CTRL_3_S [get_bd_pins AXIS_VIO_0/probe_out3] [get_bd_pins BUFG_CTRL_3/S]
connect_bd_net -net AXIS_VIO_0_probe_out0_BUFG_CTRL_0_S [get_bd_pins AXIS_VIO_0/probe_out0] [get_bd_pins BUFG_CTRL_0/S]
connect_bd_net -net AXIS_VIO_0_probe_out2_BUFG_CTRL_2_S [get_bd_pins AXIS_VIO_0/probe_out2] [get_bd_pins BUFG_CTRL_2/S]
connect_bd_net -net slot0_PORT_0_clk_p_UTIL_DS_BUF_0_IBUF_DS_P [get_bd_pins clk_p] [get_bd_pins UTIL_DS_BUF_0/IBUF_DS_P]
connect_bd_net -net UTIL_DS_BUF_1_BUFG_O_CLK_WIZ_EVE_0_clk_in1 [get_bd_pins UTIL_DS_BUF_1/BUFG_O] [get_bd_pins CLK_WIZ_EVE_0/clk_in1]
connect_bd_net -net CLK_WIZ_EVE_0_locked_POWER_0_rst_out0 [get_bd_pins CLK_WIZ_EVE_0/locked] [get_bd_pins POWER_0/rst_out0]
connect_bd_net -net CLK_WIZ_EVE_0_clk_out3_BUFG_CTRL_1_I1 [get_bd_pins CLK_WIZ_EVE_0/clk_out3] [get_bd_pins BUFG_CTRL_1/I1]
connect_bd_net -net CLK_WIZ_EVE_0_clk_out2_BUFG_CTRL_0_I1 [get_bd_pins CLK_WIZ_EVE_0/clk_out2] [get_bd_pins BUFG_CTRL_0/I1]
connect_bd_net -net CLK_WIZ_EVE_0_clk_out1_BUFG_CTRL_0_I0 [get_bd_pins CLK_WIZ_EVE_0/clk_out1] [get_bd_pins BUFG_CTRL_0/I0]
connect_bd_net -net CLK_WIZ_EVE_0_clk_out4_BUFG_CTRL_2_I1 [get_bd_pins CLK_WIZ_EVE_0/clk_out4] [get_bd_pins BUFG_CTRL_2/I1]
connect_bd_net -net BUFG_CTRL_0_O_BUFG_CTRL_1_I0 [get_bd_pins BUFG_CTRL_0/O] [get_bd_pins BUFG_CTRL_1/I0]
connect_bd_net -net BUFG_CTRL_3_O_POWER_0_system_clk [get_bd_pins BUFG_CTRL_3/O] [get_bd_pins POWER_0/system_clk]
connect_bd_net -net BUFG_CTRL_2_O_BUFG_CTRL_3_I0 [get_bd_pins BUFG_CTRL_2/O] [get_bd_pins BUFG_CTRL_3/I0]
...
connect_bd_net -net BUFG_CTRL_1_O_BUFG_CTRL_2_I0 [get_bd_pins BUFG_CTRL_1/O] [get_bd_pins BUFG_CTRL_2/I0]
connect_bd_net -net slot0_PORT_1_clk_n_UTIL_DS_BUF_0_IBUF_DS_N [get_bd_pins clk_n] [get_bd_pins UTIL_DS_BUF_0/IBUF_DS_N]
connect_bd_net [get_bd_pins UTIL_DS_BUF_1/BUFG_O] [get_bd_pins CLK_WIZ_EVE_1/clk_in1]
connect_bd_net [get_bd_pins UTIL_DS_BUF_1/BUFG_O] [get_bd_pins AXIS_VIO_0/clk]
...
set slot0 [create_bd_cell -type module -reference $new_pd slot0]
